...
public class SpinnerDataFetcherSection extends AsyncTask<String, Void, List<String>> {

    private Spinner spinner;
    private ArrayAdapter<String> adapter;

    public SpinnerDataFetcherSection(Spinner spinner) {
    ...
    protected List<String> doInBackground(String... urls) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                items.add(jsonObject.getString("division"));
            }
            return items;
